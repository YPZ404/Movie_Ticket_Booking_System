...
public class SShowManagementWindow extends JFrame implements ActionListener{
    private JButton btn_giftCardManagement, btn_movieManagement, btn_reports, btn_logout;
    ...
    public SShowManagementWindow(String s){
