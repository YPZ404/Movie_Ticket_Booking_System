...
public class MMovieManagementWindow extends JFrame implements ActionListener{
    private JButton btn_deleteFilm, btn_modify, btn_addFilm, btn_add, btn_updateFilm, btn_update;
    private JButton btn_giftCardManagement, btn_showManagement, btn_reports, btn_staffManagement, btn_logout;
    ...
    public MMovieManagementWindow(String title){
