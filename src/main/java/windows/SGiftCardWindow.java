...
public class SGiftCardWindow extends JFrame implements ActionListener{
    private JButton btn_giftCard, btn_movieManagement, btn_showManagement, btn_reports, btn_logout;
    private JTextField txt_giftCard;
    private static entity.User user;
    private JSONArray cardNumberList;

    public SGiftCardWindow(String title){
        setTitle(title);
